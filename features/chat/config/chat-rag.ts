...
const CHAT_RAG_DEFAULTS = {
  ...
  DATABASE_QUERY_TIMEOUT_MILLISECONDS: 5000,
...
export const CHAT_RAG = {
  DATABASE: {
    CONNECTION_TIMEOUT_MILLISECONDS:
      CHAT_RAG_DEFAULTS.DATABASE_CONNECTION_TIMEOUT_MILLISECONDS,
    QUERY_TIMEOUT_MILLISECONDS:
      CHAT_RAG_DEFAULTS.DATABASE_QUERY_TIMEOUT_MILLISECONDS,
    URL:
