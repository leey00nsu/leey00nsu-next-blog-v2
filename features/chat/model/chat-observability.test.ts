        ...
        rows: [
          {
            ...
            query_operation: 'lookup',
            source_strategy: 'only',
            source_categories_json: ['profile'],
            temporal_strategy: 'single',
            temporal_order: 'latest',
            execution_kind: 'direct_profile',
            graph_path_json: ['compile-plan', 'execute-direct'],
      ...
      records: [
        {
          ...
          graphPath: ['compile-plan', 'execute-direct'],
          grounded: true,
