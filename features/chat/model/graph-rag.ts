import { z } from 'zod'
import {
  ChatEvidenceTimeSchema,
  ChatSourceCategorySchema,
} from '@/features/chat/model/chat-evidence'
import { LOCALES, type SupportedLocale } from '@/shared/config/constants'

export const GRAPH_RAG_ENTITY_KINDS = ['title', 'tag', 'term'] as const

export const GraphRagEntityKindSchema = z.enum(GRAPH_RAG_ENTITY_KINDS)

export const GRAPH_RAG_RELATION_TYPES = ['co_occurs', 'same_slug'] as const
...
export const GraphRagChunkSchema = z.object({
  ...
  evidenceTime: ChatEvidenceTimeSchema.nullable().optional(),
...
export interface GraphRagRelation
  extends z.infer<typeof GraphRagRelationSchema> {}
